...
class SigesMicrorregiao extends TRecord
{
    const TABLENAME  = 'siges_microrregiao';
    const PRIMARYKEY = 'id';
    ...
    public function __construct($id = NULL, $callObjectLoad = TRUE)
    {
        ...
        parent::addAttribute('microrregiao');
    ...
    public function getSigesCidadess()
    {
        ...
        $criteria->add(new TFilter('siges_microrregiao_id', '=', $this->id));
