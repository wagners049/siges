...
class SigesRegioesEsportivas extends TRecord
{
    const TABLENAME  = 'siges_regioes_esportivas';
    const PRIMARYKEY = 'id';
    ...
    public function getSigesCidadess()
    {
        ...
        $criteria->add(new TFilter('siges_regioes_esportivas_id', '=', $this->id));
