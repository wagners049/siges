...
class SystemUsers extends TRecord
{
    ...
    /**
     * Method getSigesAtletasAntropometrias
     */
    public function getSigesAtletasAntropometrias()
    {
        $criteria = new TCriteria;
        $criteria->add(new TFilter('system_users_id', '=', $this->id));
        return SigesAtletasAntropometria::getObjects( $criteria );
    }
    /**
    ...
    /**
     * Method getSigesSociodemograficos
     */
    public function getSigesSociodemograficos()
    {
        $criteria = new TCriteria;
        $criteria->add(new TFilter('system_users_id', '=', $this->id));
        return SigesSociodemografico::getObjects( $criteria );
    }
