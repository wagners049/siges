...
class SigesPesquisasList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_SigesPesquisas';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de pesquisas");
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SigesPesquisasForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onShow = new TDataGridAction(array('SigesSurveyForm', 'onShow'));
        $action_onShow->setUseButton(false);
        $action_onShow->setButtonClass('btn btn-default btn-sm');
        $action_onShow->setLabel("Pesquisa");
        $action_onShow->setImage('far:address-card #48960f');
        $action_onShow->setField(self::$primaryKey);

        $action_onShow->setParameter('key', '{id}');
        $this->datagrid->addAction($action_onShow);

        $action_onEdit = new TDataGridAction(array('SigesPesquisasForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SigesPesquisasList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Pesquisas","Pesquisas"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new SigesPesquisas($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for SigesPesquisas
