...
class SigesTipoSerieList extends TPage
{
    private $form; // form
    ...
    private static $activeRecord = 'SigesTipoSerie';
    private static $primaryKey = 'id';
    private static $formName = 'formList_SigesTipoSerie';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle("Listagem de tipos de séries");
        ...
        $row1 = $this->form->addFields([new TLabel("Tipo:", null, '14px', null)],[$tipo]);
        $row2 = $this->form->addFields([new TLabel("Sigla:", null, '14px', null)],[$sigla]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SigesTipoSerieForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('SigesTipoSerieForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SigesTipoSerieList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastro","Tipos de Séries"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new SigesTipoSerie($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for SigesTipoSerie
