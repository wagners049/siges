...
class SigesEstadosList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_SigesEstados';
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Estado:", null, '14px', null)],[$estado]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['SigesEstadosForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_codigo_estado = new TDataGridColumn('codigo_estado', "Código IBGE", 'center' , '140px');
        $column_sigla = new TDataGridColumn('sigla', "Sigla", 'center' , '100px');
        ...
        $this->datagrid->addColumn($column_codigo_estado);
        $this->datagrid->addColumn($column_sigla);
        $this->datagrid->addColumn($column_estado);

        $action_onEdit = new TDataGridAction(array('SigesEstadosForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('SigesEstadosList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(["Cadastro","Estados"]));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new SigesEstados($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for SigesEstados
